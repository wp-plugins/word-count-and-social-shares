    ...
    <tr>
        <td>
            <div class="navdiv">
                ...
                <div class="option_img"><a href="?page=social_shares_full_time&act=csv"><img src="<?= plugins_url('images/text_csv.png', __FILE__); ?>">Create CSV</a></div>
            </div>
        </td>
    </tr>
</table>
...
<h2>Overview:</h2>
<div class="description">Full time report</div>
